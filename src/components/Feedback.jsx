...
const Feedback = () => {
  return (
    <section className="flex items-start justify-center flex-col w-[100%] p-12  md:px-64 md:py-28">
     <h2 className="text-indigo-900 font-bold text-3xl">Feedback</h2>
    <form className="my-8 mx-0 flex items-start justify-center flex-col w-[100%] gap-4 " action="no_action">
      ...
      <button className="bg-[#0196e3] text-[#f2f3f7] p-4 font-black border-[#f2f3f7] overflow-hidden cursor-pointer rounded-3xl" type="submit">Send Message</button>
    </form>
  </section>
